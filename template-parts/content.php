<section class="main-wrap">
		<div class="wrap latestpost">
				...
				<?php
					...
					if ($latest_posts->have_posts()) :
						...
						while ($latest_posts->have_posts()) : $latest_posts->the_post(); ?>
							<div class="latest-post-item col-sm-4 col-md-4 col-lg-4 mb-3">
			...
			<div class="seemore"><a class="btn" href="#" role="button" aria-label="Read more Article posts on Jahid Shah's website">Read More Article</a></div>
		</div>
	</section>